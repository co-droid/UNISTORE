import 'package:uni_olx/view_models/order_model.dart';
import 'package:uni_olx/view_models/product_model.dart';
import 'package:uni_olx/view_models/user_model.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
        ...
        child: MaterialApp(
          title: 'College OLX',
          theme: ThemeData(
            primaryColor: Colors.indigo, colorScheme: ColorScheme.fromSwatch().copyWith(secondary: Colors.black),
          ),
          home: SplashScreen(),
          routes: {
